...
public interface OutBoundOrderblservice {
	 ...
	 * 
	 * @param id
	 * @return 在出库单中增加一个快件编号，返回展示层快件的部分信息（LineItem形式）
	 */
	 ...
	 * @param id4to
	 * @param desti
	 * @return 增加一个出库单，更新变动到VO和PO，把VO信息返回到展示层
	 */
	 ...
	 * @param id4to
	 * @param desti
	 * @return 修改一个出库单，更新相关信息到VO和PO，把VO信息返回到展示层
	 */
