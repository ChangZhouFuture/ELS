...
public class PaymentOrderListui extends JPanel{
				...
				if(yearField.getText()!=null){
					...
					if(monthField.getText()!=null){
						...
						if(dayField.getText()!=null){
							...
							JavaBean1 javaBean1;
							PaymentOrderblservice deliveryOrderblservice=new PaymentOrder();
							try {
...
//		 ButtonGroup checkboxGroup=new ButtonGroup();
		 ...
		 try{
		     for(int i=0;i<arrayList.size();i++){
		    	 PaymentOrderVO oneLine=arrayList.get(i);
...
//				   PaymentOrderblservice paymentOrderblservice=new PaymentOrder();
