...
public class Order implements Orderblservice {
	...
	@Override
	public OrderVO add(String sender, String addressee, String desti, String startingPlace, ExpressType eType,
	...
	@Override
	public OrderVO modify(String sender, String addressee, String desti, String startingPlace, ExpressType eType,
			String name, String id, int num) {
		// TODO Auto-generated method stub
		return null;
	}
