...
public class DriverslineitemVO{
	...
	String driverSex;
	String driverDLP;
	public DriverslineitemVO(String id, String driverName, String driverDob, String driverIdNum,String driverCPN,String VehicleUnit,String driverSex,String driverDLP){
		super();
